#include "../include/wxMaterialOutlinedArt.hpp" 
#include <wx/regex.h> 
...
wxString OutlinedMaterialArtColorSVGByID(const wxArtID& id, const wxColour& color)
{
wxString svg = OutlinedMaterialArtSVGByID(id); 
...
wxArrayString OutlinedMaterialArtIDs()
{
    wxArrayString list; 
...
wxBitmap CreateOutlinedMaterialArtBitmapByID(const wxArtID& id, const wxSize& size, const wxColour& color)
{
  // Return SVG as a string 
  wxString svg = OutlinedMaterialArtColorSVGByID(id,color); 
...
wxBitmapBundle CreateOutlinedMaterialArtBitmapBundleByID(const wxArtID& id, const wxSize& size, const wxColour& color)
{
  // Return SVG as a string 

...
wxString SharpMaterialArtColorSVGByID(const wxArtID& id, const wxColour& color)
{
wxString svg = SharpMaterialArtSVGByID(id); 
...
wxArrayString SharpMaterialArtIDs()
{
    wxArrayString list; 
...
wxBitmap CreateSharpMaterialArtBitmapByID(const wxArtID& id, const wxSize& size, const wxColour& color)
{
  // Return SVG as a string 
  wxString svg = SharpMaterialArtColorSVGByID(id,color); 
...
wxBitmapBundle CreateSharpMaterialArtBitmapBundleByID(const wxArtID& id, const wxSize& size, const wxColour& color)
{
  // Return SVG as a string 

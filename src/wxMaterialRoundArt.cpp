...
wxString RoundMaterialArtColorSVGByID(const wxArtID& id, const wxColour& color)
{
...
wxArrayString RoundMaterialArtIDs()
{
    wxArrayString list; 
...
wxBitmap CreateRoundMaterialArtBitmapByID(const wxArtID& id, const wxSize& size, const wxColour& color)
{
  // Return SVG as a string 
  wxString svg = RoundMaterialArtColorSVGByID(id,color); 
...
wxBitmapBundle CreateRoundMaterialArtBitmapBundleByID(const wxArtID& id, const wxSize& size, const wxColour& color)
{
  // Return SVG as a string 

...
SVG_DIR: str = f"{os.path.dirname(__file__)}/../svg/"
...
def create_svg_folder_header(nameInSource: str, fontStyle: str, fontName: str):
    ...
    # Create all names
    cliup = macro_case(fontName)
    clicm = camel_case(fontName)
    art_client = "wxART_CLIENT_" + cliup + "_" + macro_case(fontStyle)
    safeguard  = art_client.upper() + "_H"

    save_path = os.path.join(os.path.dirname(__file__), "..", "include")

    header_name = "wx" + clicm + camel_case(fontStyle) + "Art"
    ...
    svg_files = sorted(glob(os.path.join(os.path.join(SVG_DIR, font, fontStyle),"*.svg")))
    ...
    for svg in svg_files:
        ...
        char_name = "SVG_" + cliup + "_" + macro_case(fontStyle) + "_" + icon_name
    ...
    fid.write("wxString " + camel_case(fontStyle) + clicm + "ArtSVGByID(const wxArtID& id);\n")
    fid.write("wxString " + camel_case(fontStyle) + clicm + "ArtColorSVGByID(const wxArtID& id, const wxColour& color=wxNullColour);\n")
    fid.write("wxArrayString " + camel_case(fontStyle) + clicm + "ArtIDs();\n")
    fid.write("wxBitmap Create" + camel_case(fontStyle) + clicm + "ArtBitmapByID(const wxArtID& id, const wxSize& size, const wxColour& color=wxNullColour);\n")
    fid.write("wxBitmapBundle Create" + camel_case(fontStyle) + clicm + "ArtBitmapBundleByID(const wxArtID& id, const wxSize& size, const wxColour& color=wxNullColour);\n")
    ...
    fcpp.write("wxString " + camel_case(fontStyle) + clicm + "ArtColorSVGByID(const wxArtID& id, const wxColour& color)\n{\n")
    fcpp.write("wxString svg = " + camel_case(fontStyle) + clicm + "ArtSVGByID(id); \n")
    ...
    fcpp.write("wxArrayString " + camel_case(fontStyle) + clicm + "ArtIDs()\n{\n")
    ...
    fcpp.write("wxBitmap Create" + camel_case(fontStyle) + clicm + "ArtBitmapByID(const wxArtID& id, const wxSize& size, const wxColour& color)\n{\n")
    fcpp.write("  // Return SVG as a string \n")
    fcpp.write("  wxString svg = " + camel_case(fontStyle) + clicm + "ArtColorSVGByID(id,color); \n")
    ...
    fcpp.write("wxBitmapBundle Create" + camel_case(fontStyle) + clicm + "ArtBitmapBundleByID(const wxArtID& id, const wxSize& size, const wxColour& color)\n{\n")
    fcpp.write("  // Return SVG as a string \n")
...
for font, actualName in actualFontNames.items():
